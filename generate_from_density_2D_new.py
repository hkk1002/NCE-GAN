...
#New method was applied to handle vanishing target area problem
...
label_CN = tf.concat([den_target/(den_target+1/V),np.zeros([mb_size,1]),1/(V*(den_target+1/V))],axis=1)
...
if G_loss_choice=='Vanilla':
    folder_name = 'out_generate_from_density_2D_new/'
elif G_loss_choice=='Minibatch':
    folder_name = 'out_generate_from_density_2D_minibatch_new/'
elif G_loss_choice=='ln2':
    folder_name = 'out_generate_from_density_2D_ln2_new/'
